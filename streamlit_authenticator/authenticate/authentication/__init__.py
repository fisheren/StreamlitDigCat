...
class AuthenticationHandler:
    ...
    def _register_credentials(self, username: str, name: str, new_institute: str, password: str, email: str,
        ...
        self.credentials['usernames'][username] = \
            {'name': name, 'institute': new_institute, 'password': Hasher([password]).generate()[0], 'email': email,
             'logged_in': False}
    ...
    def register_user(self, new_password: str, new_password_repeat: str, pre_authorization: bool,
                      new_username: str, new_institute:str, new_name: str, new_email: str,
        ...
        if pre_authorization:
            ...
            self._register_credentials(new_username, new_name, new_institute, new_password, new_email,
                                        pre_authorization, domains)
            return new_email, new_username,  new_name, new_institute
