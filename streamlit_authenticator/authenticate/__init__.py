...
class Authenticate:
    ...
    def register_user(self, location: str='main', pre_authorization: bool=True,
        ...
        """
        if fields is None:
            fields = {'Form name':'Register user', 'Email':'Email', 'Username':'Username', 'Institute': 'Institute',
        ...
        new_institute = register_user_form.text_input('Institute'
                                                            if 'Institute' not in fields
                                                            else fields['Institute']
                                                            )
        ...
        if register_user_form.form_submit_button('Register' if 'Register' not in fields
            ...
            return self.authentication_handler.register_user(new_password, new_password_repeat,
                                                             pre_authorization, new_username, new_institute,
